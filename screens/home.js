  ...
  return (
    <>
      ...
      <ScrollView>
        ...
        <Text mx={"auto"} px={"16"} pt={"1"} pb={"3"} textAlign={"justify"}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras gravida, orci nec feugiat commodo, ipsum orci consequat nulla, non sodales sem lorem et ante. 
          Etiam dignissim tempor elit, nec feugiat ante suscipit eget. Sed imperdiet diam at ultrices viverra. </Text>
          ...
          <Box px={"4"} bg={"#333333"} w={"full"} h={'290'} mx={"auto"} pt={"4"}>
